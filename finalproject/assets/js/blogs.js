...
//     // .then(data => {blogImage = data})
//     // console.log(blogImage)

// for (var key in myBlogs) {
...
//     blogTitle.innerHTML = myBlogs[key].blogTitle
//     blogAuthor = document.createElement('h6')
//     blogAuthor.innerHTML = myBlogs[key].blogAuthor
//     blogPublishedDate = document.createElement('h7')
//     blogPublishedDate.innerHTML = myBlogs[key].blogPublishedDate
...
const myBlogs = [
  ...
  function createBlog(myBlogs, obj) {
    myBlogs.map((blog, key) => {
      ...
      cardImage.setAttribute("src", obj[key].url);        
      cardBody = document.createElement("div");
      cardBody.classList.add("card-body");
      blogTitle = document.createElement("h5");
